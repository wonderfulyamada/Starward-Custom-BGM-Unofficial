...
STRINGS = {
    "en": {
        ...
        "detection_thresholds": "Recognition thresholds", "battle_start_threshold": "Battle start", "victory_threshold": "Victory", "defeat_threshold": "Defeat", "restore_detection_defaults": "Restore defaults",
        "current_match_rate": "Current match rate",
    ...
    "ja": {
        ...
        "detection_thresholds": "画像認識閾値", "battle_start_threshold": "バトル開始", "victory_threshold": "勝利", "defeat_threshold": "敗北", "restore_detection_defaults": "既定値に戻す",
        "current_match_rate": "現在の一致率",
